...
```{r, out.width="90%", fig.cap="London Cycle Hire Journeys"}
...
```{r get_rasterdir_pictures, echo=TRUE, fig.cap="UK Annualised Wind Speed Map at 45m above ground level", fig.asp=1, out.width="60%"}
...
```{r extract_vals_at_pts01, fig.asp=1, out.width="50%", fig.height=4}
...
```{r, fig.align="center", out.width="100%", fig.width=6, fig.height=2}
